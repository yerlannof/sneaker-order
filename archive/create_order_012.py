#!/usr/bin/env python3
"""
Create sneaker order ЗК-012 with per-size analytics and transit deduction.

Based on weekly-reorder skill + create_order_009.py approach.
Auto-detects articles from sales data, applies W1 check, transit from sent orders.

Usage:
    python sneaker-order/create_order_012.py --dry-run
    python sneaker-order/create_order_012.py
"""
